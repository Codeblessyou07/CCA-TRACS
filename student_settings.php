    ...
    if ($verify_data['password'] !== $current_password) {
        ...
        if (!empty($new_password)) {
            if ($new_password !== $confirm_password) {
                ...
                $update_stmt->bind_param("ssss", $new_name, $new_email, $new_password, $student_id);
            ...
            $update_stmt = $conn->prepare($update_sql);
            $update_stmt->bind_param("sss", $new_name, $new_email, $student_id);
            if ($update_stmt->execute()) {
                $_SESSION['name'] = $new_name;
                $update_message = "Profile updated successfully!";
                $user_data['name'] = $new_name;
        ...
        if (empty($update_error)) {
            $update_student_sql = "UPDATE students SET name = ? WHERE student_id = ?";
            $update_student_stmt = $conn->prepare($update_student_sql);
            $update_student_stmt->bind_param("ss", $new_name, $student_id);
...
<head>
    ...
    <title>Student Settings - CCA TRACS</title>
    <style>
...
<body>
    ...
    <div class="main-content">
        <div class="header">
            <h1><i class="fas fa-cog"></i> Student Settings</h1>
            <div class="user-name"><i class="fas fa-user"></i> <?php echo htmlspecialchars($_SESSION['name'] ?? 'Student'); ?></div>
        </div>
            ...
            <div class="settings-grid">
                <div class="settings-card">
                    ...
                    <form method="POST" action="">
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php echo htmlspecialchars($student_id); ?>" disabled style="background: #e9ecef;">
                        </div>
                        <div class="form-group">
                            <label><i class="fas fa-user"></i> Full Name</label>
                            <input type="text" name="name" value="<?php echo htmlspecialchars($user_data['name'] ?? $student_name); ?>" required>
                        </div>
                        <div class="form-group">
                ...
                <div class="settings-card">
                    ...
                    <div class="profile-info">
                        ...
                        <div class="info-row">
                            <div class="info-label"><i class="fas fa-school"></i> Section:</div>
                            <div class="info-value"><?php echo htmlspecialchars($student_data['section'] ?? 'N/A'); ?></div>
                        </div>
                        <div class="info-row">
